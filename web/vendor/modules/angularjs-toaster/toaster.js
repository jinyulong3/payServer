...
.service('toaster', ['$rootScope','toasterConfig', function ($rootScope,toasterConfig) {
    ...
    this.clearById = function(id){ //20180122增加
    	 $rootScope.$broadcast('toaster-clearToastsById',id);
    };
    ...
    return {
        ...
        link: function (scope, elm, attrs) {
            ...
            scope.$on('toaster-newToast', function () {
                toasterConfig.id=addToast(toaster.toast);
            });
            ...
            scope.$on('toaster-clearToastsById',function(d,id){ //20180122增加
//          	console.log('开始清除toaster,id为:',id);
//          	console.log(scope.toasters);
            	scope.removeToast(id);
//          	scope.toasters.splice(id-1, 1);
            });
        },
